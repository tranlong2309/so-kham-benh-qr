...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Thêm Bệnh Nhân</h1>
</div>
<!-- <ol class="breadcrumb">
<li>
<span>Patient</span>
...
<h5 class="panel-title">Nhập Thông Tin Bệnh Nhân</h5>
</div>
...
<input type="text" name="patname" class="form-control"  placeholder="Nhập Họ Tên" required="true">
</div>
<div class="form-group">
<label for="fess">
 Số điện thoại 
</label>
<input type="text" name="patcontact" class="form-control"  placeholder="Nhập số điện thoại" required="true" maxlength="12" pattern="[0-9]+">
</div>
<div class="form-group">
<label for="fess">
Email
