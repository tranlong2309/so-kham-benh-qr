...
<html lang="en">
	<head>
		<title>HuCares | SỔ KHÁM BỆNH ĐIỆN TỬ</title>
		<meta charset="UTF-8">
...
{
?>
											Có <?php echo htmlentities($num_rows1);  } ?>		
												bác sĩ</a>
...
<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-smile-o fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Bệnh Nhân</h2>
...
{
?>
Có <?php echo htmlentities($num_rows); 
} ?> bệnh nhân  		
</a>
											</p>
										</div>
